...
'sub_blocks' : [],
'non_scan_instance' : [],
'regular_scan_chain_cnt' : '384',
'edt_name' : {'main_edt': ['main_edt_top', '3', '392']},
'port_creation' : {'scan_clk': 'in', 'scan_en': 'in'},
'block_scan_external_clock_signal' : {'scan_clk': '', 'hclk_i':'', 'aclk_a_i':'', 'aclk_b_i':'', 'dfi_clk':''},
'block_scan_external_reset_signal' : {},
'block_scan_external_mode_signal'  : {},
'block_scan_internal_clock_signal' : {'occ_hclk_i': ['scan_clk', 'hclk_i'], 'occ_aclk_a_i': ['scan_clk', 'aclk_a_i'], 'occ_aclk_b_i': ['scan_clk', 'aclk_b_i'], 'occ_dfi_clk': ['scan_clk', 'dfi_clk']},
'block_scan_internal_reset_signal' : {'ahb_rst2_reg/Q': '', 'axi_a_rst2_reg/Q': '', 'axi_b_rst2_reg/Q': '', 'mc_rst2_reg/Q': ''},
'block_scan_internal_mode_signal'  : {},
'block_scan_scanen_signal'         : {'scan_en': ''},
} # block para data end
